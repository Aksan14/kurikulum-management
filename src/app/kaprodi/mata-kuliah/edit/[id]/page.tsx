...
export default function EditMataKuliahPage() {
  ...
  useEffect(() => {
    const loadMataKuliah = async () => {
      ...
      try {
        ...
        // Mock existing data
        const existingData: MataKuliahForm = {
          kode: 'TIF301',
          nama: 'Rekayasa Perangkat Lunak',
          sks: 3,
          semester: 5,
          jenis: 'wajib',
          deskripsi: 'Mata kuliah yang membahas metodologi pengembangan perangkat lunak, analisis kebutuhan, desain sistem, implementasi, pengujian, dan pemeliharaan perangkat lunak.',
          prasyarat: ['TIF201 - Struktur Data', 'TIF202 - Basis Data'],
          dosenPengampu: ['1', '2'], // Mock dosen IDs
          cpl: ['CPL-2: Mampu mengidentifikasi, merumuskan, dan menyelesaikan masalah', 'CPL-3: Mampu merancang sistem/komponen sesuai kebutuhan'],
          kompetensi: [
            'Mampu menerapkan metodologi pengembangan perangkat lunak',
            'Mampu menganalisis dan merancang kebutuhan sistem',
            'Mampu melakukan pengujian perangkat lunak',
            'Mampu mendokumentasikan sistem perangkat lunak'
          ],
          status: 'aktif'
        }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Mata Kuliah updated:', form)
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex gap-3 justify-end">
              ...
              <Button type="submit" disabled={isSubmitting}>
                ...
                {isSubmitting ? 'Menyimpan...' : 'Update Mata Kuliah'}
              </Button>
            </div>
          </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-sm text-slate-600">
                <div className="p-2 bg-slate-50 rounded">
                  <p className="font-medium text-slate-900">Terakhir diubah:</p>
                  <p>15 November 2024, 14:30</p>
                  <p>oleh: Dr. Ahmad Wijaya</p>
                </div>
                <div className="p-2 bg-slate-50 rounded">
                  <p className="font-medium text-slate-900">Dibuat:</p>
                  <p>10 Januari 2024, 09:00</p>
                  <p>oleh: Prof. Dr. Indira Sari</p>
                </div>
              </CardContent>
            </Card>
          </div>
