...
export default function DosenMataKuliahDetailPage() {
            ...
            {rps ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-sm text-slate-500 mt-1">
                  Buat RPS untuk mata kuliah ini
                </p>
                <Button className="mt-4" asChild>
                  <Link href={`/dosen/rps/create?mata_kuliah_id=${mataKuliah.id}`}>
