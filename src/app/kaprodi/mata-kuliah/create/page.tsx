...
import { mataKuliahService, CreateMataKuliahRequest } from '@/lib/api/mata-kuliah'
...
export default function CreateMataKuliahPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Creating mata kuliah:', data)
      ...
      if (response.success) {
        ...
        setError(response.message || 'Gagal membuat mata kuliah')
      }
    } catch (err: unknown) {
      ...
      if (err && typeof err === 'object' && 'message' in err) {
        ...
        setError('Terjadi kesalahan saat membuat mata kuliah')
      }
    } finally {
      ...
      <div className="space-y-6">
        ...
        {error && (
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 flex items-start gap-3">
            ...
            <div>
              <h4 className="font-medium text-red-800">Gagal Membuat Mata Kuliah</h4>
